module.exports = [{
  ...
  {
    name: "Oro-Config",
    desc: "Simple JSON based config library with command and mod menu support",
    alias: "oc",
    id: "oro_config",
    links: {
      github: "https://github.com/OroArmor/Oro-Config"
    },
    extdesc: "Simple JSON based config library with command and mod menu support"
  }
]
